...
mod tests {
    ...
    fn group_info_can_be_restored_from_participants() {
        ...
        let rig: Rig<Edwards> = Rig::new(params, &mut thread_rng());
        let expected_shared_key = rig.info.shared_key;
        let restored_info = PublicKeySet::from_participants(params, rig.info.participant_keys);
        assert_eq!(restored_info.shared_key, expected_shared_key);
    }

    fn tiny_fuzz(params: Params) {
        let mut rng = thread_rng();
    ...
    #[test]
    fn fuzz_3_of_5() {
        tiny_fuzz(Params::new(5, 3));
    }

    #[test]
    fn fuzz_4_of_5() {
        tiny_fuzz(Params::new(5, 4));
    }

    #[test]
    fn fuzz_5_of_5() {
        tiny_fuzz(Params::new(5, 5));
    }

    #[test]
    fn fuzz_6_of_10() {
        tiny_fuzz(Params::new(10, 6));
    }

    #[test]
    fn fuzz_7_of_10() {
        tiny_fuzz(Params::new(10, 7));
    }

    #[test]
    fn fuzz_8_of_10() {
        tiny_fuzz(Params::new(10, 8));
    }

    #[test]
    fn fuzz_9_of_10() {
        tiny_fuzz(Params::new(10, 9));
    }

    #[test]
    fn fuzz_10_of_10() {
        tiny_fuzz(Params::new(10, 10));
    }

    #[test]
    fn fuzz_10_of_15() {
        tiny_fuzz(Params::new(15, 10));
    }

    #[test]
    fn fuzz_12_of_15() {
        tiny_fuzz(Params::new(15, 12));
    }

    #[test]
    fn fuzz_12_of_20() {
        tiny_fuzz(Params::new(20, 12));
    }

    #[test]
    fn fuzz_16_of_20() {
        tiny_fuzz(Params::new(20, 16));
    }

    #[test]
    fn fuzz_18_of_20() {
        tiny_fuzz(Params::new(20, 18));
    }
    ...
    fn simple_voting() {
        ...
        for _ in 0..VOTES {
            ...
            for (i, variant) in choice.variants.into_iter().enumerate() {
